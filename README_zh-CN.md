...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/tanyuehao/Personal-AI-OS)
...
- [x] v0.5.0 — 数据导出、性能优化、Docker 部署
- [x] v1.0.0 — 认知引擎、Reflection、E2E 测试、安全测试
