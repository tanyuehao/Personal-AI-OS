...
from app.api import auth, documents, knowledge, chat, memory, belief, decision, usage, agent, multimodal, voice, graph, export, cognitive, reflection, decision_style, knowledge_graph, memory_network, communication_style, proactive, learning, reasoning, prediction, context as context_api, monitoring, autonomous, smarter, cognitive_model, self_transcendence
...
def create_app() -> FastAPI:
    ...
    app.include_router(self_transcendence.router, prefix=app_settings.API_V1_PREFIX)
